...
export default async function UpcomingExperiencesSection() {
    let events: Event[] = [];
    
    try {
        console.log('[UpcomingExperiencesSection] Fetching upcoming experiences...');
        events = await getUpcomingEvents(3); // Show 3 upcoming experiences
        console.log('[UpcomingExperiencesSection] Found experiences:', {
            count: events.length,
            events: events.map(e => ({
                id: e.id,
                title: e.title,
        ...
        console.error('[UpcomingExperiencesSection] Error fetching upcoming experiences:', error);
    }
                    ...
                    <div className="max-w-7xl mx-auto">
                        <div className="max-w-3xl mx-auto text-center mb-16">
                            <h2 className="text-4xl sm:text-5xl font-bold text-deep-brown mb-6">
                                Something Magical is in the Making...
                            </h2>
                            <p className="text-lg sm:text-xl text-deep-brown/80 mb-8">
                                We&apos;re crafting unforgettable forest experiences that will transport you back to simpler times. Follow our journey on Instagram to be the first to know.
                            </p>
                            <a 
                ...
                <div className="max-w-7xl mx-auto">
                    <div className="max-w-3xl mx-auto text-center mb-16 sm:mb-20">
                        ...
                        <p className="text-lg sm:text-xl text-deep-brown/80 max-w-2xl mx-auto">
                            Step away from the digital noise and into moments that remind you of life&apos;s purest joys. These aren&apos;t just experiences—they&apos;re portals to the simple pleasures we all long for.
                        </p>
                    </div>
